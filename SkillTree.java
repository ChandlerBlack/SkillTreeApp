...
public class SkillTree {
    ...
    public static void chooseVaultHunter() {
            try ( // Scanner object to get user input
    ...
    // Need to implement the skill tree for each Vault Hunter
    public static void chooseVHTree (int level){
        Scanner scanner = new Scanner(System.in);
